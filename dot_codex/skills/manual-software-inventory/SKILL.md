...
1. Before installing software, check whether Homebrew, Homebrew Cask, or the Mac App Store can manage it. Prefer those reproducible sources when they provide the intended official app.
